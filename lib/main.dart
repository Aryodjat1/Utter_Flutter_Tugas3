  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text(title, style: TextStyle(fontSize: 28, color: Colors.green, fontWeight: FontWeight.bold)),
          leading: IconButton(
            onPressed: () {},
        ...
        body: SingleChildScrollView(
          ...
          child: Column(children: <Widget>[
            ...
            Container(
                height: 150,
                child: Center(child: Icon(Icons.add, color: Colors.green, size: 30)),
